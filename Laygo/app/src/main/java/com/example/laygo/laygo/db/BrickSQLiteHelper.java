...
/**
 * Created by salom_000 on 19/10/2016.
 */

public class BrickSQLiteHelper extends SQLiteOpenHelper {
    ...
    public BrickSQLiteHelper(Context context) {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        Log.w(BrickSQLiteHelper.class.getName(),
